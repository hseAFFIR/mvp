...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "387",
            {
                "Tolstoy_Lev_Voyna_i_mir_1-2.txt": {831646, 1459244},
                "Tolstoy_Lev_Voyna_i_mir_3-4.txt": {1068984, 1511531},
            },
        ),
        (
            "Вроде готов. Пошарил по кармашкам рюкзака и выложил лишнее - репеллент, оставшийся \
ещё с прошлого сезона, благо клещей и комаров пока не было. Убрал мощный фонарик - \
время сейчас утреннее, а до темноты я тут точно не буду бродить, выезд все-таки для \
разведки и машина рядом, поэтому нечего таскать на себе лишнее. Поиск монет и других \
реликвий старины меня увлек не так давно. Сам я фантастическими достижениями \
похвастать не мог, за исключением двух серебряных рублей и золотого кольца, \
